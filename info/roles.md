...
| AI Administrator | microsoft.directory/agentUsers/delete |
| AI Administrator | microsoft.directory/agentUsers/disable |
| AI Administrator | microsoft.directory/agentUsers/enable |
| AI Administrator | microsoft.directory/agentUsers/invalidateAllRefreshTokens |
| AI Administrator | microsoft.directory/agentUsers/lifeCycleInfo/read |
| AI Administrator | microsoft.directory/agentUsers/lifeCycleInfo/update |
| AI Administrator | microsoft.directory/agentUsers/manager/update |
| AI Administrator | microsoft.directory/agentUsers/photo/update |
| AI Administrator | microsoft.directory/agentUsers/reprocessLicenseAssignment |
| AI Administrator | microsoft.directory/agentUsers/restore |
| AI Administrator | microsoft.directory/agentUsers/revokeSignInSessions |
...
| AI Reader | microsoft.directory/applications/policies/read |
| AI Reader | microsoft.directory/applications/standard/read |
| AI Reader | microsoft.directory/contacts/memberOf/read |
| AI Reader | microsoft.directory/contacts/standard/read |
| AI Reader | microsoft.directory/contracts/standard/read |
| AI Reader | microsoft.directory/domains/standard/read |
| AI Reader | microsoft.directory/entitlementManagement/allProperties/read |
| AI Reader | microsoft.directory/groupSettingTemplates/standard/read |
| AI Reader | microsoft.directory/groupSettings/standard/read |
| AI Reader | microsoft.directory/groups/appRoleAssignments/read |
| AI Reader | microsoft.directory/groups/memberOf/read |
| AI Reader | microsoft.directory/groups/members/read |
| AI Reader | microsoft.directory/groups/owners/read |
| AI Reader | microsoft.directory/groups/settings/read |
| AI Reader | microsoft.directory/groups/standard/read |
| AI Reader | microsoft.directory/oAuth2PermissionGrants/standard/read |
| AI Reader | microsoft.directory/organization/standard/read |
| AI Reader | microsoft.directory/organization/trustedCAsForPasswordlessAuth/read |
| AI Reader | microsoft.directory/roleAssignments/standard/read |
| AI Reader | microsoft.directory/roleDefinitions/standard/read |
| AI Reader | microsoft.directory/servicePrincipals/appRoleAssignedTo/read |
| AI Reader | microsoft.directory/servicePrincipals/appRoleAssignments/read |
| AI Reader | microsoft.directory/servicePrincipals/memberOf/read |
| AI Reader | microsoft.directory/servicePrincipals/oAuth2PermissionGrants/read |
| AI Reader | microsoft.directory/servicePrincipals/ownedObjects/read |
| AI Reader | microsoft.directory/servicePrincipals/owners/read |
| AI Reader | microsoft.directory/servicePrincipals/policies/read |
| AI Reader | microsoft.directory/servicePrincipals/standard/read |
| AI Reader | microsoft.directory/subscribedSkus/standard/read |
| AI Reader | microsoft.directory/users/allProperties/read |
| AI Reader | microsoft.office365.copilot/allEntities/allProperties/read |
...
| Agent ID Administrator | microsoft.directory/agentUsers/delete |
| Agent ID Administrator | microsoft.directory/agentUsers/disable |
| Agent ID Administrator | microsoft.directory/agentUsers/enable |
| Agent ID Administrator | microsoft.directory/agentUsers/invalidateAllRefreshTokens |
| Agent ID Administrator | microsoft.directory/agentUsers/lifeCycleInfo/read |
| Agent ID Administrator | microsoft.directory/agentUsers/lifeCycleInfo/update |
| Agent ID Administrator | microsoft.directory/agentUsers/manager/update |
| Agent ID Administrator | microsoft.directory/agentUsers/photo/update |
| Agent ID Administrator | microsoft.directory/agentUsers/reprocessLicenseAssignment |
| Agent ID Administrator | microsoft.directory/agentUsers/restore |
| Agent ID Administrator | microsoft.directory/agentUsers/revokeSignInSessions |
| Agent ID Administrator | microsoft.directory/agentUsers/sponsors/update |
...
| Application Administrator | microsoft.directory/servicePrincipals/synchronization.cloudTenantToExternalSystem/credentials/manage |
...
| Customer Delegated Admin Relationship Administrator | microsoft.office365.webPortal/allEntities/standard/read |
...
| Dragon Administrator | microsoft.azure.serviceHealth/allEntities/allTasks |
| Dragon Administrator | microsoft.azure.supportTickets/allEntities/allTasks |
| Dragon Administrator | microsoft.healthPlatform/allEntities/allProperties/allTasks |
| Dragon Administrator | microsoft.office365.network/performance/allProperties/read |
| Dragon Administrator | microsoft.office365.serviceHealth/allEntities/allTasks |
| Dragon Administrator | microsoft.office365.supportTickets/allEntities/allTasks |
| Dragon Administrator | microsoft.office365.usageReports/allEntities/allProperties/read |
| Dragon Administrator | microsoft.office365.webPortal/allEntities/standard/read |
...
| Exchange Backup Administrator | microsoft.azure.serviceHealth/allEntities/allTasks |
| Exchange Backup Administrator | microsoft.azure.supportTickets/allEntities/allTasks |
| Exchange Backup Administrator | microsoft.backup/exchangeProtectionPolicies/allProperties/allTasks |
| Exchange Backup Administrator | microsoft.backup/exchangeRestoreSessions/allProperties/allTasks |
| Exchange Backup Administrator | microsoft.backup/restorePoints/userMailboxes/allProperties/allTasks |
| Exchange Backup Administrator | microsoft.backup/userMailboxProtectionUnits/allProperties/allTasks |
| Exchange Backup Administrator | microsoft.backup/userMailboxRestoreArtifacts/allProperties/allTasks |
| Exchange Backup Administrator | microsoft.office365.network/performance/allProperties/read |
| Exchange Backup Administrator | microsoft.office365.serviceHealth/allEntities/allTasks |
| Exchange Backup Administrator | microsoft.office365.supportTickets/allEntities/allTasks |
| Exchange Backup Administrator | microsoft.office365.usageReports/allEntities/allProperties/read |
| Exchange Backup Administrator | microsoft.office365.webPortal/allEntities/standard/read |
...
| Global Administrator | microsoft.agentRegistry/allEntities/allProperties/allTasks |
...
| Global Administrator | microsoft.directory/backup/preview/cancel |
| Global Administrator | microsoft.directory/backup/preview/create |
| Global Administrator | microsoft.directory/backup/recovery/cancel |
| Global Administrator | microsoft.directory/backup/recovery/create |
| Global Administrator | microsoft.directory/backup/standard/read |
...
| Global Administrator | microsoft.directory/serviceAction/disableDirectoryFeature |
...
| Global Administrator | microsoft.office365.sharePointAdvancedManagement/allEntities/allProperties/allTasks |
...
| Global Reader | microsoft.agentRegistry/allEntities/allProperties/read |
...
| Global Reader | microsoft.directory/servicePrincipals/allProperties/read |
...
| Knowledge Administrator | microsoft.office365.sharePoint/allEntities/allTasks |
...
| Microsoft 365 Backup Administrator | microsoft.office365.usageReports/allEntities/allProperties/read |
...
| Organizational Data Source Administrator | microsoft.azure.serviceHealth/allEntities/allTasks |
| Organizational Data Source Administrator | microsoft.azure.supportTickets/allEntities/allTasks |
| Organizational Data Source Administrator | microsoft.microsoft365.organizationalData/allEntities/allProperties/allTasks |
| Organizational Data Source Administrator | microsoft.office365.messageCenter/messages/read |
| Organizational Data Source Administrator | microsoft.office365.serviceHealth/allEntities/allTasks |
| Organizational Data Source Administrator | microsoft.office365.supportTickets/allEntities/allTasks |
| Organizational Data Source Administrator | microsoft.office365.webPortal/allEntities/standard/read |
...
| SharePoint Advanced Management Administrator | microsoft.azure.serviceHealth/allEntities/allTasks |
| SharePoint Advanced Management Administrator | microsoft.azure.supportTickets/allEntities/allTasks |
| SharePoint Advanced Management Administrator | microsoft.backup/oneDriveForBusinessProtectionPolicies/allProperties/allTasks |
| SharePoint Advanced Management Administrator | microsoft.backup/oneDriveForBusinessRestoreSessions/allProperties/allTasks |
| SharePoint Advanced Management Administrator | microsoft.backup/restorePoints/sites/allProperties/allTasks |
| SharePoint Advanced Management Administrator | microsoft.backup/restorePoints/userDrives/allProperties/allTasks |
| SharePoint Advanced Management Administrator | microsoft.backup/sharePointProtectionPolicies/allProperties/allTasks |
| SharePoint Advanced Management Administrator | microsoft.backup/sharePointRestoreSessions/allProperties/allTasks |
| SharePoint Advanced Management Administrator | microsoft.backup/siteProtectionUnits/allProperties/allTasks |
| SharePoint Advanced Management Administrator | microsoft.backup/siteRestoreArtifacts/allProperties/allTasks |
| SharePoint Advanced Management Administrator | microsoft.backup/userDriveProtectionUnits/allProperties/allTasks |
| SharePoint Advanced Management Administrator | microsoft.backup/userDriveRestoreArtifacts/allProperties/allTasks |
| SharePoint Advanced Management Administrator | microsoft.directory/groups.unified/assignedLabels/update |
| SharePoint Advanced Management Administrator | microsoft.directory/groups.unified/basic/update |
| SharePoint Advanced Management Administrator | microsoft.directory/groups.unified/create |
| SharePoint Advanced Management Administrator | microsoft.directory/groups.unified/delete |
| SharePoint Advanced Management Administrator | microsoft.directory/groups.unified/members/update |
| SharePoint Advanced Management Administrator | microsoft.directory/groups.unified/owners/update |
| SharePoint Advanced Management Administrator | microsoft.directory/groups.unified/restore |
| SharePoint Advanced Management Administrator | microsoft.directory/groups/hiddenMembers/read |
| SharePoint Advanced Management Administrator | microsoft.office365.migrations/allEntities/allProperties/allTasks |
| SharePoint Advanced Management Administrator | microsoft.office365.network/performance/allProperties/read |
| SharePoint Advanced Management Administrator | microsoft.office365.serviceHealth/allEntities/allTasks |
| SharePoint Advanced Management Administrator | microsoft.office365.sharePoint/allEntities/allTasks |
| SharePoint Advanced Management Administrator | microsoft.office365.sharePointAdvancedManagement/allEntities/allProperties/allTasks |
| SharePoint Advanced Management Administrator | microsoft.office365.supportTickets/allEntities/allTasks |
| SharePoint Advanced Management Administrator | microsoft.office365.usageReports/allEntities/allProperties/read |
| SharePoint Advanced Management Administrator | microsoft.office365.webPortal/allEntities/standard/read |
| SharePoint Backup Administrator | microsoft.azure.serviceHealth/allEntities/allTasks |
| SharePoint Backup Administrator | microsoft.azure.supportTickets/allEntities/allTasks |
| SharePoint Backup Administrator | microsoft.backup/oneDriveForBusinessProtectionPolicies/allProperties/allTasks |
| SharePoint Backup Administrator | microsoft.backup/oneDriveForBusinessRestoreSessions/allProperties/allTasks |
| SharePoint Backup Administrator | microsoft.backup/restorePoints/sites/allProperties/allTasks |
| SharePoint Backup Administrator | microsoft.backup/restorePoints/userDrives/allProperties/allTasks |
| SharePoint Backup Administrator | microsoft.backup/sharePointProtectionPolicies/allProperties/allTasks |
| SharePoint Backup Administrator | microsoft.backup/sharePointRestoreSessions/allProperties/allTasks |
| SharePoint Backup Administrator | microsoft.backup/siteProtectionUnits/allProperties/allTasks |
| SharePoint Backup Administrator | microsoft.backup/siteRestoreArtifacts/allProperties/allTasks |
| SharePoint Backup Administrator | microsoft.backup/userDriveProtectionUnits/allProperties/allTasks |
| SharePoint Backup Administrator | microsoft.backup/userDriveRestoreArtifacts/allProperties/allTasks |
| SharePoint Backup Administrator | microsoft.office365.network/performance/allProperties/read |
| SharePoint Backup Administrator | microsoft.office365.serviceHealth/allEntities/allTasks |
| SharePoint Backup Administrator | microsoft.office365.supportTickets/allEntities/allTasks |
| SharePoint Backup Administrator | microsoft.office365.usageReports/allEntities/allProperties/read |
| SharePoint Backup Administrator | microsoft.office365.webPortal/allEntities/standard/read |
...
| Teams External Collaboration Administrator | microsoft.azure.supportTickets/allEntities/allTasks |
| Teams External Collaboration Administrator | microsoft.directory/authorizationPolicy/standard/read |
| Teams External Collaboration Administrator | microsoft.office365.webPortal/allEntities/standard/read |
| Teams External Collaboration Administrator | microsoft.teams/policies/externalAccessPolicy/allTasks |
| Teams Reader | microsoft.office365.webPortal/allEntities/standard/read |
| Teams Reader | microsoft.teams/allEntities/allProperties/read |
| Teams Telephony Administrator | microsoft.azure.serviceHealth/allEntities/allTasks |
...
| User Administrator | microsoft.directory/onPremisesSynchronization/standard/read |
...
| Viva Glint Tenant Administrator | microsoft.azure.serviceHealth/allEntities/allTasks |
| Viva Glint Tenant Administrator | microsoft.azure.supportTickets/allEntities/allTasks |
| Viva Glint Tenant Administrator | microsoft.office365.messageCenter/messages/read |
| Viva Glint Tenant Administrator | microsoft.office365.supportTickets/allEntities/allTasks |
| Viva Glint Tenant Administrator | microsoft.office365.usageReports/allEntities/allProperties/read |
| Viva Glint Tenant Administrator | microsoft.office365.webPortal/allEntities/standard/read |
| Viva Glint Tenant Administrator | microsoft.viva.glint/allEntities/allProperties/allTasks |
...
| Windows 365 Administrator | microsoft.directory/deletedItems.devices/restore |
| Windows 365 Administrator | microsoft.directory/deviceManagementPolicies/standard/read |
| Windows 365 Administrator | microsoft.directory/deviceRegistrationPolicy/standard/read |
| Windows 365 Administrator | microsoft.directory/devices/basic/update |
| Windows 365 Administrator | microsoft.directory/devices/create |
| Windows 365 Administrator | microsoft.directory/devices/delete |
| Windows 365 Administrator | microsoft.directory/devices/disable |
| Windows 365 Administrator | microsoft.directory/devices/enable |
| Windows 365 Administrator | microsoft.directory/devices/extensionAttributeSet1/update |
| Windows 365 Administrator | microsoft.directory/devices/extensionAttributeSet2/update |
...
| Windows 365 Administrator | microsoft.directory/groups.security/delete |
...
| Windows 365 Administrator | microsoft.directory/groups.security/visibility/update |
...
| Yammer Administrator | microsoft.directory/groups.unified/restore |
| Yammer Administrator | microsoft.directory/groups/hiddenMembers/read |
| Yammer Administrator | microsoft.office365.messageCenter/messages/read |
| Yammer Administrator | microsoft.office365.network/performance/allProperties/read |
| Yammer Administrator | microsoft.office365.serviceHealth/allEntities/allTasks |
| Yammer Administrator | microsoft.office365.supportTickets/allEntities/allTasks |
...
| microsoft.azure.print/printers/allProperties/read | Printer Technician |
...
| microsoft.azure.serviceHealth/allEntities/allTasks | AI Administrator, AI Reader, Agent ID Administrator, Application Administrator, Authentication Administrator, Azure Information Protection Administrator, Billing Administrator, Cloud Application Administrator, Cloud Device Administrator, Compliance Administrator, Compliance Data Administrator, Desktop Analytics Administrator, Dragon Administrator, Dynamics 365 Administrator, Dynamics 365 Business Central Administrator, Exchange Administrator, Exchange Backup Administrator, Fabric Administrator, Global Administrator, Global Reader, Groups Administrator, Helpdesk Administrator, Hybrid Identity Administrator, Insights Administrator, License Administrator, Microsoft 365 Backup Administrator, Microsoft Graph Data Connect Administrator, Office Apps Administrator, Organizational Data Source Administrator, Partner Tier1 Support, Partner Tier2 Support, Power Platform Administrator, Privileged Authentication Administrator, Reports Reader, Security Administrator, Security Reader, Service Support Administrator, SharePoint Administrator, SharePoint Advanced Management Administrator, SharePoint Backup Administrator, Skype for Business Administrator, Teams Administrator, Teams Communications Administrator, Teams Communications Support Engineer, Teams Communications Support Specialist, Teams Telephony Administrator, User Administrator, Viva Glint Tenant Administrator |
| microsoft.azure.supportTickets/allEntities/allTasks | AI Administrator, Agent ID Administrator, Application Administrator, Authentication Administrator, Authentication Policy Administrator, Azure Information Protection Administrator, Billing Administrator, Cloud Application Administrator, Compliance Administrator, Compliance Data Administrator, Desktop Analytics Administrator, Dragon Administrator, Dynamics 365 Administrator, Exchange Administrator, Exchange Backup Administrator, Fabric Administrator, Global Administrator, Global Secure Access Administrator, Groups Administrator, Helpdesk Administrator, Hybrid Identity Administrator, Insights Administrator, Intune Administrator, Microsoft 365 Backup Administrator, Microsoft Graph Data Connect Administrator, Office Apps Administrator, Organizational Data Source Administrator, Partner Tier1 Support, Partner Tier2 Support, Power Platform Administrator, Privileged Authentication Administrator, Security Administrator, Security Operator, Service Support Administrator, SharePoint Administrator, SharePoint Advanced Management Administrator, SharePoint Backup Administrator, Skype for Business Administrator, Teams Administrator, Teams Communications Administrator, Teams External Collaboration Administrator, Teams Telephony Administrator, User Administrator, Viva Glint Tenant Administrator, Windows 365 Administrator |
...
| microsoft.backup/exchangeProtectionPolicies/allProperties/allTasks | Exchange Administrator, Exchange Backup Administrator |
| microsoft.backup/exchangeRestoreSessions/allProperties/allTasks | Exchange Administrator, Exchange Backup Administrator |
| microsoft.backup/oneDriveForBusinessProtectionPolicies/allProperties/allTasks | SharePoint Administrator, SharePoint Advanced Management Administrator, SharePoint Backup Administrator |
| microsoft.backup/oneDriveForBusinessRestoreSessions/allProperties/allTasks | SharePoint Administrator, SharePoint Advanced Management Administrator, SharePoint Backup Administrator |
| microsoft.backup/restorePoints/sites/allProperties/allTasks | SharePoint Administrator, SharePoint Advanced Management Administrator, SharePoint Backup Administrator |
| microsoft.backup/restorePoints/userDrives/allProperties/allTasks | SharePoint Administrator, SharePoint Advanced Management Administrator, SharePoint Backup Administrator |
| microsoft.backup/restorePoints/userMailboxes/allProperties/allTasks | Exchange Administrator, Exchange Backup Administrator |
| microsoft.backup/sharePointProtectionPolicies/allProperties/allTasks | SharePoint Administrator, SharePoint Advanced Management Administrator, SharePoint Backup Administrator |
| microsoft.backup/sharePointRestoreSessions/allProperties/allTasks | SharePoint Administrator, SharePoint Advanced Management Administrator, SharePoint Backup Administrator |
| microsoft.backup/siteProtectionUnits/allProperties/allTasks | SharePoint Administrator, SharePoint Advanced Management Administrator, SharePoint Backup Administrator |
| microsoft.backup/siteRestoreArtifacts/allProperties/allTasks | SharePoint Administrator, SharePoint Advanced Management Administrator, SharePoint Backup Administrator |
| microsoft.backup/userDriveProtectionUnits/allProperties/allTasks | SharePoint Administrator, SharePoint Advanced Management Administrator, SharePoint Backup Administrator |
| microsoft.backup/userDriveRestoreArtifacts/allProperties/allTasks | SharePoint Administrator, SharePoint Advanced Management Administrator, SharePoint Backup Administrator |
| microsoft.backup/userMailboxProtectionUnits/allProperties/allTasks | Exchange Administrator, Exchange Backup Administrator |
| microsoft.backup/userMailboxRestoreArtifacts/allProperties/allTasks | Exchange Administrator, Exchange Backup Administrator |
...
| microsoft.directory/agentUsers/delete | AI Administrator, Agent ID Administrator |
| microsoft.directory/agentUsers/disable | AI Administrator, Agent ID Administrator |
| microsoft.directory/agentUsers/enable | AI Administrator, Agent ID Administrator |
| microsoft.directory/agentUsers/invalidateAllRefreshTokens | AI Administrator, Agent ID Administrator |
| microsoft.directory/agentUsers/lifeCycleInfo/read | AI Administrator, AI Reader, Agent ID Administrator |
| microsoft.directory/agentUsers/lifeCycleInfo/update | AI Administrator, Agent ID Administrator |
| microsoft.directory/agentUsers/manager/update | AI Administrator, Agent ID Administrator |
| microsoft.directory/agentUsers/photo/update | AI Administrator, Agent ID Administrator |
| microsoft.directory/agentUsers/reprocessLicenseAssignment | AI Administrator, Agent ID Administrator |
| microsoft.directory/agentUsers/restore | AI Administrator, Agent ID Administrator |
| microsoft.directory/agentUsers/revokeSignInSessions | AI Administrator, Agent ID Administrator |
| microsoft.directory/agentUsers/sponsors/update | AI Administrator, Agent ID Administrator |
| microsoft.directory/agentUsers/usageLocation/update | AI Administrator, Agent ID Administrator |
| microsoft.directory/agentUsers/userPrincipalName/update | AI Administrator, Agent ID Administrator |
...
| microsoft.directory/applicationPolicies/standard/read | AI Reader, Application Administrator, Cloud Application Administrator, Directory Readers, Global Secure Access Administrator, User |
...
| microsoft.directory/authorizationPolicy/standard/read | Azure Information Protection Administrator, Cloud Device Administrator, Compliance Data Administrator, Desktop Analytics Administrator, Global Reader, Kaizala Administrator, License Administrator, Security Administrator, Security Operator, Security Reader, Teams Administrator, Teams Communications Administrator, Teams Communications Support Engineer, Teams Communications Support Specialist, Teams External Collaboration Administrator, Teams Telephony Administrator, User |
...
| microsoft.directory/conditionalAccessPolicies/allProperties/allTasks | Global Administrator |
| microsoft.directory/conditionalAccessPolicies/allProperties/read | Global Reader |
| microsoft.directory/conditionalAccessPolicies/basic/update | Conditional Access Administrator, Security Administrator |
| microsoft.directory/conditionalAccessPolicies/create | Conditional Access Administrator, Security Administrator |
| microsoft.directory/conditionalAccessPolicies/delete | Conditional Access Administrator, Security Administrator |
...
| microsoft.directory/contacts/memberOf/read | AI Reader, Directory Readers, Exchange Administrator, User |
| microsoft.directory/contacts/standard/read | AI Reader, Directory Readers, Exchange Administrator, User |
| microsoft.directory/contracts/allProperties/allTasks | Global Administrator |
| microsoft.directory/contracts/standard/read | AI Reader, Directory Readers, User |
...
| microsoft.directory/deviceLocalCredentials/standard/read | Global Reader, Helpdesk Administrator, Security Administrator, Security Reader |
| microsoft.directory/deviceManagementPolicies/basic/update | Cloud Device Administrator, Global Administrator |
...
| microsoft.directory/groupSettingTemplates/standard/read | AI Reader, Azure AD Joined Device Local Administrator, Directory Readers |
...
| microsoft.directory/groupSettings/standard/read | AI Reader, Azure AD Joined Device Local Administrator, Directory Readers |
...
| microsoft.directory/groups.security/createAsOwner | Knowledge Administrator, Knowledge Manager |
| microsoft.directory/groups.security/delete | Intune Administrator, Knowledge Administrator, Knowledge Manager, Windows 365 Administrator |
| microsoft.directory/groups.security/dynamicMembershipRule/update | Intune Administrator, Windows 365 Administrator |
...
| microsoft.directory/groups.unified/assignedLabels/update | Exchange Administrator, Partner Tier1 Support, Partner Tier2 Support, SharePoint Administrator, SharePoint Advanced Management Administrator, Teams Administrator, User Administrator, Yammer Administrator |
| microsoft.directory/groups.unified/basic/update | Exchange Administrator, SharePoint Administrator, SharePoint Advanced Management Administrator, Teams Administrator, Yammer Administrator |
| microsoft.directory/groups.unified/create | Exchange Administrator, SharePoint Administrator, SharePoint Advanced Management Administrator, Teams Administrator, Yammer Administrator |
| microsoft.directory/groups.unified/createAsOwner | Agent ID Administrator |
| microsoft.directory/groups.unified/delete | Exchange Administrator, SharePoint Administrator, SharePoint Advanced Management Administrator, Teams Administrator, Yammer Administrator |
| microsoft.directory/groups.unified/members/update | Exchange Administrator, SharePoint Administrator, SharePoint Advanced Management Administrator, Teams Administrator, Yammer Administrator |
| microsoft.directory/groups.unified/owners/update | Exchange Administrator, SharePoint Administrator, SharePoint Advanced Management Administrator, Teams Administrator, Yammer Administrator |
| microsoft.directory/groups.unified/restore | Exchange Administrator, SharePoint Administrator, SharePoint Advanced Management Administrator, Teams Administrator, Yammer Administrator |
...
| microsoft.directory/groups/appRoleAssignments/read | AI Reader, Directory Readers, User |
...
| microsoft.directory/groups/hiddenMembers/read | Agent ID Administrator, Exchange Administrator, Groups Administrator, Intune Administrator, SharePoint Administrator, SharePoint Advanced Management Administrator, Teams Administrator, User Administrator, Yammer Administrator |
| microsoft.directory/groups/memberOf/limitedRead | Guest User |
| microsoft.directory/groups/memberOf/read | AI Reader, Directory Readers, User |
| microsoft.directory/groups/members/limitedRead | Guest User |
| microsoft.directory/groups/members/read | AI Reader, Directory Readers, User |
...
| microsoft.directory/groups/owners/read | AI Reader, Directory Readers, User |
...
| microsoft.directory/groups/settings/read | AI Reader, Directory Readers |
...
| microsoft.directory/groups/standard/read | AI Reader, Directory Readers, User |
...
| microsoft.directory/oAuth2PermissionGrants/standard/read | AI Reader, Directory Readers, User |
...
| microsoft.directory/organization/standard/read | AI Reader, Agent ID Administrator, Directory Readers, Dynamics 365 Business Central Administrator, User |
...
| microsoft.directory/organization/trustedCAsForPasswordlessAuth/read | AI Reader, Directory Readers |
...
| microsoft.directory/policies/standard/read | Agent ID Administrator, Security Reader, User, User Administrator |
...
| microsoft.directory/roleAssignments/standard/read | AI Reader, Directory Readers, User |
...
| microsoft.directory/roleDefinitions/standard/read | AI Reader, Directory Readers, User |
...
| microsoft.directory/serviceAction/enableDirectoryFeature | Global Administrator |
| microsoft.directory/serviceAction/getAvailableExtentionProperties | Global Administrator, Global Reader |
| microsoft.directory/servicePrincipalCreationPolicies/basic/update | Global Administrator |
| microsoft.directory/servicePrincipalCreationPolicies/create | Global Administrator |
| microsoft.directory/servicePrincipalCreationPolicies/delete | Global Administrator |
...
| microsoft.directory/servicePrincipals/appRoleAssignedTo/read | AI Reader, Directory Readers, User |
...
| microsoft.directory/servicePrincipals/appRoleAssignments/read | AI Reader, Directory Readers, User |
...
| microsoft.directory/servicePrincipals/memberOf/read | AI Reader, Directory Readers, User |
...
| microsoft.directory/servicePrincipals/oAuth2PermissionGrants/read | AI Reader, Directory Readers, User |
| microsoft.directory/servicePrincipals/ownedObjects/limitedRead | Guest User, Restricted Guest User |
| microsoft.directory/servicePrincipals/ownedObjects/read | AI Reader, Directory Readers, User |
| microsoft.directory/servicePrincipals/owners/limitedRead | Guest User, Restricted Guest User |
| microsoft.directory/servicePrincipals/owners/read | AI Reader, Directory Readers, User |
...
| microsoft.directory/servicePrincipals/policies/read | AI Reader, Directory Readers, User |
...
| microsoft.directory/servicePrincipals/standard/read | AI Reader, Agent ID Developer, Directory Readers, User |
...
| microsoft.directory/userCredentialPolicies/owners/read | Authentication Policy Administrator |
| microsoft.directory/userCredentialPolicies/owners/update | Authentication Policy Administrator |
...
| microsoft.directory/users/allProperties/read | AI Administrator, AI Reader, Global Reader |
...
| microsoft.directory/verifiableCredentials/configuration/contracts/allProperties/update | Authentication Policy Administrator, Global Administrator |
| microsoft.directory/verifiableCredentials/configuration/contracts/cards/allProperties/read | Authentication Policy Administrator, Global Administrator, Global Reader |
| microsoft.directory/verifiableCredentials/configuration/contracts/cards/revoke | Authentication Policy Administrator, Global Administrator |
| microsoft.directory/verifiableCredentials/configuration/contracts/create | Authentication Policy Administrator, Global Administrator |
| microsoft.directory/verifiableCredentials/configuration/create | Authentication Policy Administrator, Global Administrator |
| microsoft.directory/verifiableCredentials/configuration/delete | Authentication Policy Administrator, Global Administrator |
| microsoft.dynamics365.businessCentral/allEntities/allProperties/allTasks | Dynamics 365 Business Central Administrator |
| microsoft.dynamics365/allEntities/allTasks | Dynamics 365 Administrator, Global Administrator, Power Platform Administrator |
...
| microsoft.insights/queries/allProperties/allTasks | Insights Analyst |
...
| microsoft.microsoft365.organizationalData/allEntities/allProperties/allTasks | Global Administrator, Organizational Data Source Administrator |
| microsoft.microsoft365.organizationalData/allEntities/allProperties/read | Global Reader |
...
| microsoft.office365.copilot/allEntities/allProperties/read | AI Reader, Global Reader |
...
| microsoft.office365.fileStorageContainers/allEntities/allProperties/allTasks | Global Administrator, SharePoint Embedded Administrator |
...
| microsoft.office365.messageCenter/messages/read | AI Administrator, AI Reader, Global Administrator, Global Reader, Global Secure Access Administrator, Hybrid Identity Administrator, Message Center Privacy Reader, Message Center Reader, Microsoft Graph Data Connect Administrator, Microsoft Hardware Warranty Administrator, Office Apps Administrator, Organizational Data Source Administrator, Search Administrator, Search Editor, User Experience Success Manager, Viva Glint Tenant Administrator, Viva Pulse Administrator, Yammer Administrator |
| microsoft.office365.messageCenter/securityMessages/read | Global Administrator, Global Reader, Message Center Privacy Reader |
| microsoft.office365.migrations/allEntities/allProperties/allTasks | Global Administrator, Microsoft 365 Migration Administrator, SharePoint Administrator, SharePoint Advanced Management Administrator |
| microsoft.office365.network/locations/allProperties/allTasks | Network Administrator |
| microsoft.office365.network/performance/allProperties/read | AI Administrator, AI Reader, Dragon Administrator, Exchange Administrator, Exchange Backup Administrator, Global Administrator, Global Reader, Microsoft 365 Backup Administrator, Network Administrator, Reports Reader, Service Support Administrator, SharePoint Administrator, SharePoint Advanced Management Administrator, SharePoint Backup Administrator, SharePoint Embedded Administrator, Teams Administrator, Usage Summary Reports Reader, User Experience Success Manager, Yammer Administrator |
...
| microsoft.office365.protectionCenter/allEntities/standard/read | Security Administrator, Security Reader |
| microsoft.office365.protectionCenter/attackSimulator/payload/allProperties/allTasks | Attack Payload Author, Attack Simulation Administrator, Security Administrator |
| microsoft.office365.protectionCenter/attackSimulator/payload/allProperties/read | Security Reader |
| microsoft.office365.protectionCenter/attackSimulator/reports/allProperties/read | Attack Payload Author, Attack Simulation Administrator, Security Administrator, Security Reader |
| microsoft.office365.protectionCenter/attackSimulator/simulation/allProperties/allTasks | Attack Simulation Administrator, Security Administrator |
| microsoft.office365.protectionCenter/attackSimulator/simulation/allProperties/read | Security Reader |
| microsoft.office365.protectionCenter/sensitivityLabels/allProperties/read | Knowledge Administrator |
...
| microsoft.teams/allEntities/allProperties/read | Global Reader, Teams Reader |
| microsoft.teams/callQuality/allProperties/read | Teams Communications Administrator, Teams Communications Support Engineer, Teams Telephony Administrator |
...
| microsoft.teams/policies/externalAccessPolicy/allTasks | Teams External Collaboration Administrator |
| microsoft.teams/voice/allProperties/allTasks | Teams Communications Administrator, Teams Telephony Administrator |
...
| microsoft.viva.glint/allEntities/allProperties/allTasks | Global Administrator, Viva Glint Tenant Administrator |
| microsoft.viva.glint/allEntities/allProperties/read | Global Reader |
